...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST)) {
	...
	$awayTeamEnter  	= $_POST["awayTeamChange"];
	$reserveTeamEnter 	= $_POST["reserveTeamChange"];
	$scoreEnter 		= $_POST["scoreChange"];
...
<?php 	header("Location: http://e0712763mathewbowyer.myitoc.com.au/oakTown/admin.php#error");
	...
	try {
		...
		$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		 $sql = "INSERT INTO teams (dateTime, homeTeam, awayTeam, reserveTeam, homeLogo, awayLogo, score)
			VALUES ('$date', '$homeTeamEnter', '$awayTeamEnter', '$reserveTeamEnter', '$newfilename', '$newfilename1', '$scoreEnter')";
